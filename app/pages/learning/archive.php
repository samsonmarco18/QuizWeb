...
<section class="glass panel compact-panel"><div class="empty-state"><?php echo nav_icon('archive'); ?><h2>No archived classes</h2><p>Your active classrooms remain under My Classes.</p><a class="button button-secondary" href="/QuizWeb/classes.php">View Classes</a></div></section>
<?php render_footer(); ?>
